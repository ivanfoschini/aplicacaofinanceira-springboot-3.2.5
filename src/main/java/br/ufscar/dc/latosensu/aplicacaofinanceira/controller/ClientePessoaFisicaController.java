...
public class ClientePessoaFisicaController {
    ...
    public ClientePessoaFisica save(@RequestBody @Valid ClientePessoaFisica clientePessoaFisica) throws EmptyCollectionException, NotFoundException, NotUniqueException {
        return clientePessoaFisicaService.save(clientePessoaFisica);
    }

    @PutMapping("/update/{id}")
    public ClientePessoaFisica update(@PathVariable("id") long id, @RequestBody @Valid ClientePessoaFisica clientePessoaFisica) throws EmptyCollectionException, NotFoundException, NotUniqueException {
