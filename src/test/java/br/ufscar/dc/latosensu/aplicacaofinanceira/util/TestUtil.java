...
public class TestUtil {
    ...
    public static final String NOME_DE_USUARIO = "nomeDeUsuario";
    ...
    public static final String VALIDATION_EXCEPTION = "br.ufscar.dc.latosensu.aplicacaofinanceira.exception.ValidationException";
